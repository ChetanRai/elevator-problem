...
public class Elevator {
    ...
    public Elevator(int currentFloor) {
        ...
        UP = new PriorityQueue<>((a, b) -> a.desiredFloor - b.desiredFloor);

        // use a max heap
        DOWN =  new PriorityQueue<>((a, b) -> b.desiredFloor - a.desiredFloor);
    }
    ...
    public void sendUpRequest(Request upRequest) {
        ...
        if (upRequest.location == Location.OUTSIDE_ELEVATOR) {
            ...
            UP.offer(new Request(upRequest.currentFloor,
    ...
    public void sendDownRequest(Request downRequest) {
        ...
        if (downRequest.location == Location.OUTSIDE_ELEVATOR) {
            DOWN.offer(new Request(downRequest.currentFloor,
